    ...
    public sealed class LeaderHistoryCandidatePromotionJob
    {
        ...
        private static LeaderHistoryEntry BuildLeader(CandidateLedgerEntry candidate, string runId, int lookbackTradingDays)
        {
            ...
            return new LeaderHistoryEntry
            {
                ...
                ForeignNetBuyQuantity = candidate.ForeignNetBuyQuantity,
                InstitutionNetBuyQuantity = candidate.InstitutionNetBuyQuantity,
                IsForeignInstitutionDoubleNetBuy = candidate.IsForeignInstitutionDoubleNetBuy,
                InvestorNetBuyScore = candidate.InvestorNetBuyScore,
