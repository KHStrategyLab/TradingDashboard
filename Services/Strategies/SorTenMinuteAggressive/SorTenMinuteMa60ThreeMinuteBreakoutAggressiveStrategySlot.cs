        ...
        : TradingStrategySlotBase
    {
        ...
        public override StrategyEvaluationResult Evaluate(StrategyEvaluationContext context)
        {
            ...
            StrategyProgressSnapshot progress = StrategyProgressCalculator.Build(
                ...
                context.IsOwned ? $"position tracking / {exitBreak.Reason}" : hasSignal ? "buy signal candidate" : "10min MA60 / 3min breakout tracking",
                [
            ...
            return new StrategyEvaluationResult(
                ...
                context.IsOwned
                    ? $"exit tracking after aggressive entry / {minuteDataText} / {exitBreak.Reason}"
